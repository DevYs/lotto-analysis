...
const ordering = (arr) => arr.sort((a,b) => b - a);
...
const draw20games = () => {
	...
	numbers = getNumbers();
	games.push(numbers.slice(0, 6).sort((a, b) => a - b));
	games.push(numbers.slice(6, 12).sort((a, b) => a - b));
	games.push(numbers.slice(12, 18).sort((a, b) => a - b));
	games.push(numbers.slice(18, 24).sort((a, b) => a - b));
	games.push(numbers.slice(24, 30).sort((a, b) => a - b));
	games.push(numbers.slice(30, 36).sort((a, b) => a - b));
	games.push(numbers.slice(36, 42).sort((a, b) => a - b));
